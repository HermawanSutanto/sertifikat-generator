...
export default function CreateDesignPage() {
  ...
  return (
    <div className="flex flex-col h-screen bg-[#F2EAD3] text-[#17233D]">
      <header className="bg-white shadow-sm border-b border-[#17233D]/15 z-10">
        <div className="w-full max-w-full mx-auto px-6 py-3 flex justify-between items-center">
          <div className="flex items-center gap-4">
            <Link href="/" className="text-xl font-bold text-[#17233D]">
              SertiGen Designer
            </Link>
            <input
              type="text"
              ...
              className="text-sm p-2 border border-[#17233D]/15 rounded-md"
            />
          ...
          <div className="flex items-center gap-4">
            <button
              ...
              className="px-5 py-2 text-sm font-medium text-[#8C2F39] bg-[#8C2F39]/10 rounded-lg hover:bg-[#8C2F39]/20"
            >
              Ekspor PNG
            </button>
            <button
              ...
              disabled={isLoading}
              className="px-5 py-2 text-sm font-semibold text-white bg-[#8C2F39] rounded-lg shadow-sm hover:bg-[#742531] disabled:bg-[#A9822E]/60 flex items-center gap-2"
            >
      ...
      <div className="flex-grow flex overflow-hidden">
        {/* Toolbar */}
        <aside className="w-64 bg-[#FCFAF2] p-6 space-y-6 border-r border-[#17233D]/15 overflow-y-auto">
          <div>
            <h3 className="font-semibold mb-3">Elemen</h3>
            <div className="space-y-2">
              <button
                onClick={() => handleAddText("text")}
                className="w-full flex items-center gap-3 p-3 text-left text-sm font-medium rounded-lg hover:bg-[#F2EAD3]"
              >
                <svg
                  className="w-5 h-5 text-[#17233D]/50"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                >
          ...
          <div className="border-t border-[#17233D]/10 pt-6">
        ...
        {/* Properties Panel */}
        <aside className="w-72 bg-[#FCFAF2] p-6 border-l border-[#17233D]/15 overflow-y-auto">
          ...
          {selectedElement ? (
            <div className="space-y-4 mt-4">
              ...
              {selectedElement.type === "text" && (
                <>
                  <div>
                    <label className="block text-sm font-medium text-[#17233D]/70 mb-1">
                      Teks
                    </label>
                    <textarea
                      ...
                      className="w-full p-2 border border-[#17233D]/15 rounded-md"
                      rows="3"
                    />
                  </div>
                  <div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className="w-full h-10 p-1 border border-[#17233D]/15 rounded-md"
                      />
                    </div>
                  </div>
                </>
              ...
              {selectedElement.type === "image" && (
                <div>
                  <p className="text-sm text-[#17233D]/70">
              ...
              <div className="border-t border-[#17233D]/10 pt-4">
                <h3 className="font-semibold text-sm mb-2">Pengaturan</h3>
                <div className="flex items-center gap-2">
                  <button
                    onClick={() => handleLayerChange("up")}
                    className="flex-1 p-2 text-xs rounded-md bg-[#F2EAD3] hover:bg-[#17233D]/10"
                  >
                    Naikkan Layer
                  </button>
                  <button
            ...
            <div className="mt-4 text-sm text-center text-[#17233D]/50 bg-[#F2EAD3] p-4 rounded-lg">
          ...
          <div className="border-t border-[#17233D]/10 pt-6">
            ...
            <p className="text-xs text-[#17233D]/50 mb-3">
